...
public class DuongTheActivity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duong_the);
    ...
    private void getData(int page) {
        compositeDisposable.add(apiBanHang.getSanPham(page,loai)
                ...
                .subscribe(
                        ...
                        throwable -> {
                            Toast.makeText(getApplicationContext(),"Không kết nối đuợc với server", Toast.LENGTH_LONG).show();
                        }
                ));
    }

...
public class ChitietAdapter extends RecyclerView.Adapter<ChitietAdapter.MyViewHolder> {
    ...
    // Tạo ViewHolder để hiển thị từng mục trong RecyclerView
    @NonNull
    @Override
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chitiet, parent, false); // Inflate layout item_chitiet.xml để tạo ra một View mới
        return new MyViewHolder(view);
    }
    // Đặt dữ liệu từ mục (Item) vào ViewHolder
    @Override
